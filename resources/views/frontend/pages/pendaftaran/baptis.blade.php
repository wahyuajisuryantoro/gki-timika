...
@section('content')
    <div class="container">
        ...
        <form id="baptisForm" action="{{ route('pendaftaran.storeBaptis') }}" method="POST" enctype="multipart/form-data"
            class="rd-form">
            @csrf
            <div class="form-wrap">
            ...
            <!-- TAMBAHKAN INPUT AKTA KELAHIRAN DI SINI -->
            <div class="form-wrap">
                <input type="file" class="form-input" id="akta_kelahiran" name="akta_kelahiran"
                    accept=".pdf,.jpg,.jpeg,.png" required>
                <label class="form-label-outside" for="akta_kelahiran">Akta Kelahiran (PDF, JPG, JPEG, PNG - Max
                    2MB)</label>
            </div>
...
@section('script')
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // File validation untuk semua file input termasuk akta kelahiran
