...
@section('content')
    <div class="container">
        ...
        <form id="sidiForm" action="{{ route('pendaftaran.storeSidi') }}" method="POST" enctype="multipart/form-data"
            class="rd-form">
            @csrf
            <div class="form-wrap">
...
@section('script')
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            const form = document.getElementById('sidiForm');
            ...
            tanggalLahir.addEventListener('change', function() {
                ...
                if (age < 12) {
                    Swal.fire({
                        ...
                        text: 'Umur minimal untuk sidi adalah 12 tahun',
            ...
            function checkNomorIndukExists(nomorInduk) {
                ...
                fetch('{{ route('pendaftaran.storeSidi') }}', {
                        method: 'POST',
                        body: formData,
                        headers: {
